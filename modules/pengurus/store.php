...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $db->prepare("INSERT INTO ustadz_pengurus (nama, jenis_kelamin, pendidikan_terakhir, jabatan, tahun_mulai, no_hp, alamat) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([
            $_POST['nama'], 
            $_POST['jenis_kelamin'], 
        ...
        echo json_encode(['status' => 'success', 'message' => 'Data Pengurus berhasil ditambahkan']);
